...
// if(!indice.isPresent()) {
// throw new ResponseStatusException(HttpStatus.NOT_FOUND, "Aucun indice
// n'existe pour cet id");
// }
// return indice.get();
// }
// catch(FirebaseAuthException e) {
...
// @PostMapping("/create")
// public Indice create(@RequestBody Indice indice,
// @RequestHeader("Authorization") String jwt){
// try{
// FirebaseAuth.getInstance().verifyIdToken(jwt);
...
// public Indice update(@PathVariable(value = "indiceID") int id, @RequestBody
// Indice indice) {
// try{
// FirebaseAuth.getInstance().verifyIdToken(jwt);
// if(id == indice.getId()){
...
// }
// else{
// throw new ResponseStatusException(HttpStatus.PRECONDITION_FAILED, "L'id de
// l'indice passé en paramètre est différent de celui saisi.");
// }
// }
// catch(FirebaseAuthException e) {
// throw new ResponseStatusException(HttpStatus.UNAUTHORIZED, "Unauthorized");
...
// throw new ResponseStatusException(HttpStatus.NOT_FOUND, "L'indice n'existe
// pas");
// }
// indiceService.deleteIndice(id);
// } catch(FirebaseAuthException e) {
